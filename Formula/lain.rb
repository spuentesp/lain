...
class Lain < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/spuentesp/lain/releases/download/v0.5.0/lain-0.5.0-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/spuentesp/lain/releases/download/v0.5.0/lain-0.5.0-x86_64-unknown-linux-gnu.tar.gz"
