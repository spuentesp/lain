...
class Lain < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/spuentesp/lain/releases/download/v0.7.4/lain-0.7.4-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/spuentesp/lain/releases/download/v0.7.4/lain-0.7.4-x86_64-unknown-linux-gnu.tar.gz"
  ...
  on_windows do
    on_intel do
      url "https://github.com/spuentesp/lain/releases/download/v0.7.4/lain-0.7.4-x86_64-pc-windows-msvc.tar.gz"
